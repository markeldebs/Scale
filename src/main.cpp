...
#define ledPin1 21          // digital output pin for LED 1
#define ledPin2 22         // digital output pin for LED 2
#define ledPin3 17         // digital output pin for LED 3
#define ledPin4 33         // digital output pin for LED 4
